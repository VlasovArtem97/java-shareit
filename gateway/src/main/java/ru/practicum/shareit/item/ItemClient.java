...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addComment(Long userId, Long itemId, CommentDto newCommentDto) {
        return post("/{itemId}/comment", userId, Map.of("itemId", itemId), newCommentDto);
    }
